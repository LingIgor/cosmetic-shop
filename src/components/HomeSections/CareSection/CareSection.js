...
return (<div style={{display:"flex", marginTop:"140px"}}>
<div style={{width:"700px",height:"583px", background:"#F4F1ED", marginLeft:"-30px"}}>
...
<div style={{width:"670px", height:"451px", position:"relative", left:"-150px"}}>
    <BackPhoto />
